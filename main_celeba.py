...
if __name__ == '__main__':
    ...
    elif FLAGS.method == "helvae":
        FLAGS.modality_helvae = True
    elif FLAGS.method == "joint_helvae":
        FLAGS.joint_helvae = True
    else:
    ...
    # print(FLAGS.modality_helvae)
    # print(FLAGS.joint_helvae)
