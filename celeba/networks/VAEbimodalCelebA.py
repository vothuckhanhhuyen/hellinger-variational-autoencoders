...
class VAEbimodalCelebA(BaseMMVae, nn.Module):
    ...
    def forward(self, input_batch):
        ...
        class_embeddings = BaseMMVae.reparameterize(self, latents['joint'][0],
                                                latents['joint'][1]);
        ...
        if 'img' in input_batch.keys():
            ...
            if self.flags.factorized_representation:
                m1_s_embeddings = BaseMMVae.reparameterize(self, mu=m1_s_mu, logvar=m1_s_logvar);
            else:
        ...
        if 'text' in input_batch.keys():
            ...
            if self.flags.factorized_representation:
                m2_s_embeddings = BaseMMVae.reparameterize(self, mu=m2_s_mu, logvar=m2_s_logvar);
            else:
