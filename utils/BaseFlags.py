...
# helvae
parser.add_argument('--modality_helvae', type=bool, default=False, help="modality_helvae")
parser.add_argument('--joint_helvae', type=bool, default=False, help="modality_helvae")
parser.add_argument("--ver_type", type=str)
